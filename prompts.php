...
$wsPromptText = buildAiWorkspacePrompt('ws-prompts');
...
<?php $activeNav = 'prompts'; require __DIR__ . '/includes/dev_center_nav.php'; ?>
...
<main class="dc-main">
  ...
  <div class="dc-hero">
    <div class="dc-hero-row">
      ...
      <button class="ws-launch-btn" data-workspace="ws-prompts" data-action="codex">⚡ Codex 열기</button>
      <?php endif; ?>
      <?php if (in_array('claude', $wsLaunchAllowed, true)): ?>
      <button class="ws-launch-btn" data-workspace="ws-prompts" data-action="claude">🤖 Claude 열기</button>
      <?php endif; ?>
      <?php if (in_array('vscode-codex', $wsLaunchAllowed, true)): ?>
      <button class="ws-launch-btn" data-workspace="ws-prompts" data-action="vscode-codex">🖥️ VSCode + Codex</button>
      <?php endif; ?>
