...
window.COPIER_COMPONENT_REGISTRY = {
    ...
    "components": [
        ...
        },
        {
            ...
            "category": "layout",
            "status": "prototype",
            "summary": "toner식 탭 모달(정보/납품이력). 정보 탭에 부서별 장비 + 부서/장비/거래처 CRUD. 모바일=풀스크린 시트+큰 터치+⋯ 액션시트(수정/이전/처분). 삭제는 하드삭제 아님(이전/처분).",
            "tags": [
                "prototype",
                "company",
                "거래처",
