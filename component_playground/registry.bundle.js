...
window.COPIER_COMPONENT_REGISTRY = {
    ...
    "components": [
        ...
        },
        {
            ...
            "category": "layout",
            "status": "prototype",
            "summary": "toner식 탭 모달(정보/납품이력). 정보 탭에 부서별 장비 + 부서 추가/삭제·장비 추가/삭제·거래처 수정/삭제. 삭제는 실제 구현 시 이력/이전 처리 필요(예약카드 참조).",
            "tags": [
                "prototype",
                "company",
                "거래처",
